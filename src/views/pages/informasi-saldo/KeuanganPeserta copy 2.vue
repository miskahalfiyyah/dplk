<template>
  <v-section>
    ...
    <v-data-table
      ...
      disable-sort
    >
      <template v-slot:item="{ akumulasi }">
        <tr>
          <td>{{ akumulasi.contrib }}</td>
          <td>{{ akumulasi.distrib }}</td>
          <td>{{ akumulasi.net_contrib }}</td>
          <td>{{ akumulasi.earning }}</td>
          <td>{{ akumulasi.fee }}</td>
          <td>{{ akumulasi.acct_val }}</td>
          <!-- <td>{{ akumulasi.total_unit }}</td> -->
        </tr>
      </template>
      <template slot="body.append">
        ...
        >
          <th style="color: #234069 !important">
            Total
          </th>
          <th style="color: #234069 !important">
            {{ sumField('total_contrib') }}
          </th>
          <th style="color: #234069 !important">
            {{ sumField('total_distrib') }}
          </th>
          <th style="color: #234069 !important">
            {{ sumField('total_net_contrib') }}
          </th>
          <th style="color: #234069 !important">
            {{ sumField('total_earning') }}
          </th>
          <th style="color: #234069 !important">
            {{ sumField('total_fee') }}
          </th>
          <th style="color: #234069 !important">
            {{ sumField('total_acct_val') }}
          </th>
